...
> **Prev:** [9.9 Blazor overview](9.09-blazor-overview.md) · **Next:** [10.1 REST principles](../10-web-api-design/10.01-rest-principles.md)
...
⚠️ **Placement in the pipeline matters** ([5.2](../05-middleware/5.02-middleware-order.md)). Put
...
required once credentials are involved ([16.9](../16-security/16.09-cors.md)).
...
([16.11](../16-security/16.11-common-vulnerabilities.md)).
...
- [5.2 Middleware order](../05-middleware/5.02-middleware-order.md) — why placement matters
- [5.5 Built-in middleware](../05-middleware/5.05-builtin-middleware.md) — `UseStaticFiles` in context
- [16.9 CORS](../16-security/16.09-cors.md) — configuring cross-origin properly
- [16.11 Common vulnerabilities](../16-security/16.11-common-vulnerabilities.md) — path traversal
- [10.1 REST principles](../10-web-api-design/10.01-rest-principles.md) — the API the SPA calls
- [24.10 CDN and caching](../24-devops-hosting/24.10-cdn-caching.md) — production asset delivery
